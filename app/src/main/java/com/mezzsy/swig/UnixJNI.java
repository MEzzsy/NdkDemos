...
public class UnixJNI {
  public final static native void global_int_set(int jarg1);
  public final static native int global_int_get();
  ...
  public final static native int CONST_VALUE_1_get();
  public final static native int CONST_VALUE_2_get();
